window.onload = function() {
	...
	document.getElementById('reset-but').onfocus = function() {
		document.getElementById('fio').style.boxShadow = "0 0 15px 4px #aaa";
		document.getElementById('age').style.boxShadow = "0 0 15px 4px #aaa";
		document.getElementById('sex').style.boxShadow = "0 0 15px 4px #aaa";
		document.getElementById('telef').style.boxShadow = "0 0 15px 4px #aaa";
		document.getElementById('email').style.boxShadow = "0 0 15px 4px #aaa";
		document.getElementById('data-r').style.boxShadow = "0 0 15px 4px #aaa";
