window.onload = function() {
	...
	var addCountS = parseInt(sessionStorage.getItem('MP'))+1;
	sessionStorage.setItem('MP',addCountS);
	...
	var addCountL = parseInt(localStorage.getItem('MP'))+1;
	localStorage.setItem('MP',addCountL);
}
