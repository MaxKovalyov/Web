window.onload = function() {
	...
	var addCountS = parseInt(sessionStorage.getItem('S'))+1;
	sessionStorage.setItem('S',addCountS);
	...
	var addCountL = parseInt(localStorage.getItem('S'))+1;
	localStorage.setItem('S',addCountL);
}
